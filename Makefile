...
.PHONY: install-req fmt test test-bazel-jvm-integration test-bazel-go-integration test-python-integration test-gradle-integration test-npm-integration test-npm-matrix update-gradle-fixtures lint tidy imports install-golangci-lint
