...
// Two packages sharing a name but not a version are two nodes, and each takes
// the children its own name maps to. Children are looked up by name alone,
// which is snyk-nuget-plugin's behavior.
