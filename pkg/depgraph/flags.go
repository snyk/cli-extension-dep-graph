...
const (
	...
	FlagBunWorkspacePackages          = "internal-bun-workspace-packages"
)
...
func getFlagSet() *pflag.FlagSet {
	...
	flagSet.Bool(FlagBunWorkspacePackages, false, "Include all bun workspace packages in the dependency graph output")
